...
<head>
    ...
    <meta name="description" content="KH Downloader Terms of Service covering personal use, user responsibility, intellectual property, availability, and warranty limits.">
    <link rel="canonical" href="{{ route('pages.terms') }}">
    <title>Terms of Service - KH Downloader</title>
